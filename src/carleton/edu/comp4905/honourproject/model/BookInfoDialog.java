...
/**
 * this class represents view of book information dialog
 *
 * @author Zhangda Yang
 */
public class BookInfoDialog extends javax.swing.JDialog {

    // the complement of this panel
    ...
    // customized view of dialog info
    private void initEnvironment() {
        ...
        if (theBook == null) {
            ...
            if (bookCodeField.getText().trim().length() > 2) {
    ...
    // action performs when user clicked Browser button;
    ...
    protected void updateInfo(Book b, Controller.operation anOperation) {
        ...
        if (theBook != null) {
            ...
            bookCodeField.setText(theBook.getBookCode());
            if (bookCodeField.getText().trim().length() > 4) {
                bookCodeField.setEditable(false);
            }
            bookNameField.setText(theBook.getBookName());
            bookPathField.setText(theBook.getBookPath());
