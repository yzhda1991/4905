...
public class PageInfoDialog extends javax.swing.JDialog {
    ...
    public PageInfoDialog(java.awt.Frame parent, String title,dialogClient theclient, Page p,dialogClient.operation aopertion ,boolean modal) {
        super(parent,"page info", modal);
        theDialogClient = theclient;
        thePage = p;
        mode = aopertion;
        initEnvironment();
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        disableFocusLost();
          if(errorfound){
            ...
            if(theDialogClient !=null)theDialogClient.pageDialogFinished(mode);      
                dispose();
